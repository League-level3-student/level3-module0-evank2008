...
public class _02_2DArrayPractice {
    ...
    public Integer[][] test1() {
        Integer[][] grid = {{1,2,3},{4,5,6},{7,8,9}};
        return grid;
    }
    ...
    public Boolean[][] test3() {
        Boolean[][]grid= {{true,false},{false,false},{false,true},{true,true},{true,false}};
        return grid;
    }
